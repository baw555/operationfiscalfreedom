...
export default function Home() {
  ...
  useEffect(() => {
    ...
    const interval = setInterval(() => {
      setSlideOpacity(0); // Start fade out
      
      setTimeout(() => {
        setCurrentSlideIndex(prev => (prev + 1) % SLIDESHOW_IMAGES.length);
        setSlideOpacity(1); // Fade back in
      }, 500); // Quick switch after fade out
    }, 5000);
        ...
        >
          ...
          {!introStarted && (
            <>
              <div 
                ...
                style={{
                  backgroundImage: `url(${SLIDESHOW_IMAGES[currentSlideIndex]})`,
          ...
          {introStarted && (
            <div 
              ...
              style={{ backgroundImage: `url(${SLIDESHOW_IMAGES[0]})` }}
            />
          )}
          ...
          <video
            ...
            poster={SLIDESHOW_IMAGES[currentSlideIndex]}
            playsInline
            preload="auto"
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-10 sm:mb-16">
            ...
            <p className="text-sm sm:text-lg text-gray-600 max-w-3xl mx-auto px-2">
              Anyone can participate in our platform to earn money and every transaction helps fund the programs and resources NAV-USA provides to Veterans and their families.
            </p>
          </div>
