...
import { Award, CheckCircle, ArrowRight, TrendingUp, Zap, DollarSign } from "lucide-react";
    ...
    <Layout>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-lg sm:text-xl text-slate-300 mb-8 max-w-3xl mx-auto">
              Maximize your savings with federal and state tax credits designed for businesses like yours.
            </p>
            <Link 
              href="/veteran-led-tax/intake" 
              className={cn(buttonVariants({ size: "lg" }), "bg-white text-slate-900 hover:bg-slate-100 font-bold px-8")}
            >
              Explore Your Credits <ArrowRight className="ml-2 w-4 h-4" />
            </Link>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-5xl mx-auto">
            <div className="grid md:grid-cols-3 gap-8 mb-12">
              {[
                { icon: TrendingUp, title: "R&D Tax Credits", desc: "Recover costs of innovation and development" },
                { icon: Zap, title: "Energy Credits", desc: "Incentives for energy-efficient investments" },
                { icon: DollarSign, title: "Hiring Credits", desc: "WOTC and other employment incentives" }
              ].map((item) => (
            ...
            <div className="bg-white rounded-xl p-8 shadow-sm">
              <h2 className="text-2xl font-display text-brand-navy mb-6">Available Credits & Incentives</h2>
      ...
      <section className="py-16 sm:py-20 bg-brand-navy text-white">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-2xl sm:text-3xl font-display mb-4">Claim Every Credit You Deserve</h2>
          <p className="text-slate-300 mb-8 max-w-2xl mx-auto">
            Many businesses miss valuable tax credits. Let us find yours.
          </p>
          <Link 
            href="/veteran-led-tax/intake" 
