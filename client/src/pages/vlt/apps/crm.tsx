...
import { Users, CheckCircle, ArrowRight, Database, Bell, BarChart } from "lucide-react";
    ...
    <Layout>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-lg sm:text-xl text-slate-300 mb-8 max-w-3xl mx-auto">
              Client relationship management built for tax professionals.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-5xl mx-auto">
            <div className="grid md:grid-cols-3 gap-8 mb-12">
              {[
                { icon: Database, title: "Client Database", desc: "Centralized client information" },
                { icon: Bell, title: "Automated Reminders", desc: "Never miss important deadlines" },
                { icon: BarChart, title: "Reporting", desc: "Track performance and progress" }
              ].map((item) => (
            ...
            <div className="bg-white rounded-xl p-8 shadow-sm">
              <h2 className="text-2xl font-display text-brand-navy mb-6">CRM Features</h2>
      ...
      <section className="py-16 sm:py-20 bg-brand-navy text-white">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-2xl sm:text-3xl font-display mb-4">Experience Our Technology</h2>
          <p className="text-slate-300 mb-8 max-w-2xl mx-auto">
            See how our CRM keeps your tax engagement on track.
          </p>
          <Link 
