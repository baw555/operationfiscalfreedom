...
import { DollarSign, CheckCircle, ArrowRight, Search, RefreshCw, FileCheck } from "lucide-react";
    ...
    <Layout>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-lg sm:text-xl text-slate-300 mb-8 max-w-3xl mx-auto">
              Review overpayments and amendment opportunities—recover what's rightfully yours.
            </p>
            <Link 
              href="/veteran-led-tax/intake" 
              className={cn(buttonVariants({ size: "lg" }), "bg-white text-slate-900 hover:bg-slate-100 font-bold px-8")}
            >
              Start Recovery Review <ArrowRight className="ml-2 w-4 h-4" />
            </Link>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-5xl mx-auto">
            <div className="grid md:grid-cols-3 gap-8 mb-12">
              {[
                { icon: Search, title: "Deep Review", desc: "Thorough analysis of past returns" },
                { icon: RefreshCw, title: "Amendment Filing", desc: "Correct errors and claim missed credits" },
                { icon: FileCheck, title: "Documentation", desc: "Proper records for every recovery" }
              ].map((item) => (
            ...
            <div className="bg-white rounded-xl p-8 shadow-sm">
              <h2 className="text-2xl font-display text-brand-navy mb-6">Recovery Services</h2>
              <div className="grid md:grid-cols-2 gap-4">
                {[
                  "Prior Year Return Review",
                  "Amended Return Preparation",
                  "Missed Deduction Recovery",
                  "Credit Recapture Analysis",
      ...
      <section className="py-16 sm:py-20 bg-brand-navy text-white">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-2xl sm:text-3xl font-display mb-4">Money Left on the Table?</h2>
          <p className="text-slate-300 mb-8 max-w-2xl mx-auto">
            Let us review your past returns and recover what you're owed.
          </p>
          <Link 
            href="/veteran-led-tax/intake" 
