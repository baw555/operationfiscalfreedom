...
import { BookOpen, CheckCircle, ArrowRight, BarChart, FileText, TrendingUp } from "lucide-react";

export default function OutsourcedAccounting() {
  return (
    <Layout>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-lg sm:text-xl text-slate-300 mb-8 max-w-3xl mx-auto">
              Clean books, clear decisions—monthly close, reports, and financial hygiene without the overhead.
            </p>
            <Link 
              href="/veteran-led-tax/intake" 
              className={cn(buttonVariants({ size: "lg" }), "bg-white text-slate-900 hover:bg-slate-100 font-bold px-8")}
            >
              Get Accounting Quote <ArrowRight className="ml-2 w-4 h-4" />
            </Link>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-5xl mx-auto">
            <div className="grid md:grid-cols-3 gap-8 mb-12">
              {[
                { icon: BarChart, title: "Monthly Reporting", desc: "Financial statements you can rely on" },
                { icon: FileText, title: "Clean Books", desc: "Accurate, organized financial records" },
                { icon: TrendingUp, title: "Business Insights", desc: "Data-driven decision support" }
              ].map((item) => (
            ...
            <div className="bg-white rounded-xl p-8 shadow-sm">
              <h2 className="text-2xl font-display text-brand-navy mb-6">Accounting Services</h2>
      ...
      <section className="py-16 sm:py-20 bg-brand-navy text-white">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-2xl sm:text-3xl font-display mb-4">Focus on Your Business</h2>
          <p className="text-slate-300 mb-8 max-w-2xl mx-auto">
            Let us handle the books while you grow your company.
          </p>
          <Link 
            href="/veteran-led-tax/intake" 
