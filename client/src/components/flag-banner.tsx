...
export function FlagBanner() {
  const marqueeText = "ALL VETERANS GET FREE JOB TRAINING • FREE DOCUMENT SIGNING SOFTWARE • FREE GENERATIVE AI • OPERATOR AI THAT DOESN'T CENSOR - WE DON'T STORE - TRACK YOU • SAVE ON INSURANCE • GET WORK • GET PAID FOR REFERRING FELLOW VETERANS AND FAMILY";
