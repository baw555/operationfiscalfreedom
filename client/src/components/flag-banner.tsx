...
export function FlagBanner() {
  ...
  const marqueeText = "NAVIGATORUSA - SUPPORT VETERAN HEALTH, EDUCATION AND FINANCIAL LITERACY! • GROWING # OF WAYS TO EARN $$$ • VETERANS GET FREE LINEMAN SCHOOL, TOOLS & OTHER WORK PROGRAMS • SAVE 20-40% ON ALL BUSINESS + PERSONAL INSURANCE - DIRECT TO INSURERS & 70 CARRIERS • REFER & EARN $$$ • GET NO-OUT-OF-POCKET VA DISABILITY RATINGS w/ BEST LAW FIRMS IN US • SPECIALIZED TAX CREDITS FOR BUSINESS • WORK • WORK • WORK • FREE DOCUMENT SIGNING SOFTWARE • GENERATIVE AI • OPERATOR AI (CENSORLESS - PRIVATE)";
