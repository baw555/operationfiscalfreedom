...
**Generated:** 2026-02-08 (auto-generated by `scripts/audit-ui-bindings.ts`)  
...
| **Total useQuery hooks** | 66 |
| **Total `: any` / `as any` uses** | 118 |
| **Local interface definitions** | 116 |
| **Imports from shared/schema** | 2 |
...
|---|---|---|---|---|---|---|
| `admin-dashboard.tsx` | 15 | 16 | 2 | 4 | 0 | 0 |
| `claims-navigator.tsx` | 15 | 6 | 11 | 7 | 7 | 0 |
| `affiliate-dashboard.tsx` | 11 | 16 | 2 | 1 | 0 | 1 |
...
- `admin-dashboard.tsx` — 16 uses of `any`, 15 queries, no shared types
- `affiliate-dashboard.tsx` — Hardcoded commission percentages duplicated from backend
...
1. **Zero imports from shared/schema** — 2 imports found
2. **118 uses of `any` typing** — Backend shape changes produce zero compile errors
