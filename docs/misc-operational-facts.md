...
**Generated:** 2026-02-08 (auto-generated by `scripts/audit-misc.ts`)  
...
| registerRoutes defined | `server/routes.ts` | 331 | `export async function registerRoutes(` |
| Trust proxy (routes) | `server/routes.ts` | 335 | `// trust proxy is set once in server/index.ts — do not duplicate here` |
...
|---|---|---|---|---|
| `resolveClientIp` | 13 | `master`, `admin` | YES | IP resolution utility, not an auth guard |
| `requireAdmin` | 17 | `master`, `admin` | YES |  |
| `requireAffiliate` | 36 | `affiliate` | YES |  |
| `requireAffiliateWithNda` | 63 | `affiliate` | YES | Checks NDA + CONTRACT via getLegalStatus() |
| `getVeteranUserId` | 101 | — | NO |  |
| `requireClaimOwner` | 109 | — | NO |  |
...
- Inline `getResendClient()` calls (no retry): **10** at lines 1426, 1492, 2011, 2611, 4733, 6322, 6426, 6681, 7027, 10490
- `sendEmailWithRetry()` calls (with retry): **3** at lines 193, 978, 6689
...
|---|---|---|
| `req.ip` (Express built-in, trust-proxy aware) | 25 | `routes.ts:282`, `routes.ts:316`, `routes.ts:1753`, `routes.ts:1781`, `routes.ts:1837`, `routes.ts:2967`, `routes.ts:3024`, `routes.ts:3049`, `routes.ts:3505`, `routes.ts:3601`, `routes.ts:3949`, `routes.ts:3970`, `routes.ts:3989`, `routes.ts:5474`, `routes.ts:6623`, `routes.ts:6730`, `routes.ts:6742`, `routes.ts:6765`, `routes.ts:6964`, `routes.ts:8105`, `routes.ts:8140`, `routes.ts:8203`, `routes.ts:8243`, `routes.ts:8310`, `routes.ts:8347` |
| Manual `x-forwarded-for` header parsing | 13 | `routes.ts:489`, `routes.ts:561`, `routes.ts:932`, `routes.ts:1214`, `routes.ts:3743`, `routes.ts:4455`, `routes.ts:4930`, `routes.ts:5473`, `routes.ts:7429`, `routes.ts:7632`, `routes.ts:7757`, `legal-system.ts:103`, `legal-system.ts:186` |
| `resolveClientIp()` helper | 1 | `routes.ts:25` |
