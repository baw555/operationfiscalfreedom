...
**Generated:** 2026-02-07 (auto-generated by `scripts/audit-schema.ts`)  
...
| 92 | `sessions` | `sid` | varchar | — | 0 |
| 93 | `veteran_auth_users` | `id` | varchar | `email` | 0 |
